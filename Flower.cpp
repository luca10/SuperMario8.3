...
Flower::Flower(QPoint position) : Entity()
{
	...
	texture_cycle[0] = loadTexture(":/graphics/World8.3/flower-0.bmp");
	texture_cycle[1] = loadTexture(":/graphics/World8.3/flower-1.bmp");
	texture_cycle[2] = loadTexture(":/graphics/World8.3/flower-2.bmp");
	texture_cycle[3] = loadTexture(":/graphics/World8.3/flower-3.bmp");
